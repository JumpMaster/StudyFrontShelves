...
int8_t ledPins[8] = { 7, 8, 9, 10, 11, 12, 13, -1 };
...
/*
HAMqttDevice shelf1("Shelf 1", HAMqttDevice::LIGHT);
HAMqttDevice shelf2("Shelf 1", HAMqttDevice::LIGHT);
HAMqttDevice shelf3("Shelf 1", HAMqttDevice::LIGHT);
HAMqttDevice shelf4("Shelf 1", HAMqttDevice::LIGHT);
HAMqttDevice shelf5("Shelf 1", HAMqttDevice::LIGHT);
HAMqttDevice shelf6("Shelf 1", HAMqttDevice::LIGHT);
*/
#endif